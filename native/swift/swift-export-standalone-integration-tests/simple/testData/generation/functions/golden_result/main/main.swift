...
public func foo(
    ...
    return __root___foo__TypesOfArguments__Swift_Optional_main_Foo___(receiver.map { it in it.__externalRCRef() } ?? .none)
}
...
public func getBar(
    ...
    return __root___bar_get__TypesOfArguments__Swift_Optional_main_Foo___(receiver.map { it in it.__externalRCRef() } ?? .none)
}
public func getFoo(
    _ receiver: Swift.Int32
) -> Swift.String {
...
public func getFoo(
    ...
    return __root___foo_get__TypesOfArguments__Swift_Optional_main_Foo___(receiver.map { it in it.__externalRCRef() } ?? .none)
}
...
public func setFoo(
    ...
    return __root___foo_set__TypesOfArguments__Swift_Optional_main_Foo__Swift_String__(receiver.map { it in it.__externalRCRef() } ?? .none, v)
}
...
public extension ExportedKotlinPackages.overload {
    ...
    public static func foo(
        ...
        return overload_foo__TypesOfArguments__Swift_Optional_ExportedKotlinPackages_overload_Foo___(arg1.map { it in it.__externalRCRef() } ?? .none)
    }
}
