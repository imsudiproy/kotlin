...
public final class Foo: KotlinRuntime.KotlinBase, KotlinRuntimeSupport._KotlinBridged {
    public var any_value: KotlinRuntime.KotlinBase? {
        get {
            return { switch Foo_any_value_get(self.__externalRCRef()) { case .none: .none; case let res: KotlinRuntime.KotlinBase(__externalRCRef: res); } }()
        }
    }
    public var value: main.Bar? {
        get {
            return { switch Foo_value_get(self.__externalRCRef()) { case .none: .none; case let res: main.Bar(__externalRCRef: res); } }()
        }
    }
    public var variable: main.Bar? {
        get {
            return { switch Foo_variable_get(self.__externalRCRef()) { case .none: .none; case let res: main.Bar(__externalRCRef: res); } }()
        }
        set {
            return Foo_variable_set__TypesOfArguments__Swift_Optional_main_Bar___(self.__externalRCRef(), newValue.map { it in it.__externalRCRef() } ?? .none)
        }
    }
    package override init(
        __externalRCRef: Swift.UnsafeMutableRawPointer?
    ...
    public init(
        ...
        super.init(__externalRCRef: __kt)
        __root___Foo_init_initialize__TypesOfArguments__Swift_UnsafeMutableRawPointer_Swift_Optional_main_Bar___(__kt, b.map { it in it.__externalRCRef() } ?? .none)
    }
    public func accept(
        b: main.Bar?
    ) -> Swift.Void {
        return Foo_accept__TypesOfArguments__Swift_Optional_main_Bar___(self.__externalRCRef(), b.map { it in it.__externalRCRef() } ?? .none)
    }
    public func produce() -> main.Bar? {
        return { switch Foo_produce(self.__externalRCRef()) { case .none: .none; case let res: main.Bar(__externalRCRef: res); } }()
    }
}
...
public func foo(
    ...
    return __root___foo__TypesOfArguments__Swift_Optional_main_Bar___(a.map { it in it.__externalRCRef() } ?? .none)
}
public func foo_any(
...
public func foo_any(
    ...
    return __root___foo_any__TypesOfArguments__Swift_Optional_KotlinRuntime_KotlinBase___(a.map { it in it.__externalRCRef() } ?? .none)
}
public func opt_to_non_opt_usage(
    i: main.OptToNonOptTypealias
) -> Swift.Void {
    return __root___opt_to_non_opt_usage__TypesOfArguments__Swift_Optional_main_Bar___(i.map { it in it.__externalRCRef() } ?? .none)
}
public func p() -> main.Bar? {
    return { switch __root___p() { case .none: .none; case let res: main.Bar(__externalRCRef: res); } }()
}
public func p_any() -> KotlinRuntime.KotlinBase? {
    return { switch __root___p_any() { case .none: .none; case let res: KotlinRuntime.KotlinBase(__externalRCRef: res); } }()
}
public func p_opt_opt_in(
    input: main.OptOptRef
) -> Swift.Void {
    return __root___p_opt_opt_in__TypesOfArguments__Swift_Optional_main_Bar___(input.map { it in it.__externalRCRef() } ?? .none)
}
public func p_opt_opt_out() -> main.OptOptRef {
    return { switch __root___p_opt_opt_out() { case .none: .none; case let res: main.Bar(__externalRCRef: res); } }()
}
