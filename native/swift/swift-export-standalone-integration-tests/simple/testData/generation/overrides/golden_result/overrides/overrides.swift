...
open class Child: overrides.Parent {
    open override var objectOptionalVar: overrides.Parent? {
        get {
            return { switch Child_objectOptionalVar_get(self.__externalRCRef()) { case .none: .none; case let res: overrides.Parent(__externalRCRef: res); } }()
        }
    }
    ...
    open override func actuallyOverride(
        ...
        return Child_actuallyOverride__TypesOfArguments__Swift_Optional_Swift_Int32__overrides_Parent_Swift_Optional_overrides_Parent___(self.__externalRCRef(), nullable.map { it in NSNumber(value: it) } ?? nil, poly.__externalRCRef(), nullablePoly.map { it in it.__externalRCRef() } ?? .none)
    }
    ...
    open override func objectOptionalFunc(
        ...
        return { switch Child_objectOptionalFunc__TypesOfArguments__overrides_Child__(self.__externalRCRef(), arg.__externalRCRef()) { case .none: .none; case let res: overrides.Parent(__externalRCRef: res); } }()
    }
...
open class Parent: KotlinRuntime.KotlinBase, KotlinRuntimeSupport._KotlinBridged {
    open var objectOptionalVar: overrides.Parent? {
        get {
            return { switch Parent_objectOptionalVar_get(self.__externalRCRef()) { case .none: .none; case let res: overrides.Parent(__externalRCRef: res); } }()
        }
    }
    ...
    open var subtypeOptionalObjectVar: overrides.Parent? {
        get {
            return { switch Parent_subtypeOptionalObjectVar_get(self.__externalRCRef()) { case .none: .none; case let res: overrides.Parent(__externalRCRef: res); } }()
        }
    }
    ...
    open func objectOptionalFunc(
        ...
        return { switch Parent_objectOptionalFunc__TypesOfArguments__overrides_Child__(self.__externalRCRef(), arg.__externalRCRef()) { case .none: .none; case let res: overrides.Parent(__externalRCRef: res); } }()
    }
    ...
    open func subtypeOptionalObjectFunc() -> overrides.Parent? {
        return { switch Parent_subtypeOptionalObjectFunc(self.__externalRCRef()) { case .none: .none; case let res: overrides.Parent(__externalRCRef: res); } }()
    }
