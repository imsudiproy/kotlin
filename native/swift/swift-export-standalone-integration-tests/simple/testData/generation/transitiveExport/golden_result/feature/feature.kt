...
@ExportedBridge("oh_my_kotlin_FeatureB_init_initialize__TypesOfArguments__Swift_UInt__")
public fun oh_my_kotlin_FeatureB_init_initialize__TypesOfArguments__Swift_UInt__(__kt: kotlin.native.internal.NativePtr): Unit {
    val ____kt = kotlin.native.internal.ref.dereferenceExternalRCRef(__kt)!!
