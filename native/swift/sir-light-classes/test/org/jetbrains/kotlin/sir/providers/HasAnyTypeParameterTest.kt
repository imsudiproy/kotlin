...
class HasAnyTypeParameterTest(val inlineSourceCodeAnalysis: InlineSourceCodeAnalysis) {
    ...
    fun `test - has any type parameter`() {
        ...
        withAnalysisSession(file) { ktFile ->
            ...
            assertTrue(parentGeneric.hasAnyTypeParameter(this))
            assertTrue(childGeneric.hasAnyTypeParameter(this))

            assertFalse(parentNoGeneric.hasAnyTypeParameter(this))
            assertFalse(childNoGeneric.hasAnyTypeParameter(this))
        }
    }
}