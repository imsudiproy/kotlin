...
internal constructor(
    ...
    @get:IgnoreEmptyDirectories
    @get:InputFiles
    val inputResourceFiles: ConfigurableFileCollection = objectFactory.fileCollection()
    ...
    private fun mergeResources(fatResources: File) {
        fileOperations.copy {
            it.from(inputResourceFiles)
            it.into(fatResources)
    ...
    protected fun createFatFramework() {
        ...
        mergeResources(outFramework.rootDir)
    }
